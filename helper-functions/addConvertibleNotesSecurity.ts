...
class addConvertibleNoteSecurity {
    ...
    async addConvertibleNoteSecurity(security: any): Promise<void> {
        ...
        let convertibleNoteLocators = this.capTablePage.getSelectorForConvertibleNoteLedgerCell();
        await this.page.getByLabel('Add Security').click();
        await this.page.waitForTimeout(1500);
        await locators.security_name_cell.dblclick();
        await locators.security_name_cell_editor.fill(security.name);
...
export default addConvertibleNoteSecurity;