...
test.describe('Fund Ownership', () => {
    ...
    test('Add a CapTable with Preferred Stock security', async () => {
    ...
    test('TR0699 - Add a Fund Ownership with Preferred Stock security', async () => {
        ...
        // Select Preferred Stock security type
